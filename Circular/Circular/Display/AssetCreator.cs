...
namespace Circular.Display {
    ...
    public class AssetCreator {
        ...
        public void LoadContent () {
            _materials [MaterialType.Blank] = ContentHelper.GetTexture ( "blank" );
            _materials [MaterialType.Dots] = ContentHelper.GetTexture ( "dots" );
            _materials [MaterialType.Squares] = ContentHelper.GetTexture ( "squares" );
            _materials [MaterialType.Waves] = ContentHelper.GetTexture ( "waves" );
            _materials [MaterialType.Pavement] = ContentHelper.GetTexture ( "pavement" );
        }
        ...
        private Texture2D RenderTexture ( int width, int height, Texture2D material,
            ...
            var fill = new List < VertexPositionColorTexture[] > ( 1 );
