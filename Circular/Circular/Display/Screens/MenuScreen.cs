...
namespace Circular.Display.Screens {
    public class MenuScreen : GameScreen {
        ...
        public void AddMenuItem ( LevelBase screen, Texture2D preview ) {
            ...
            if ( input.IsMenuSelect() ) {
                if ( GetPreviewCollision( input.Cursor ) ) {
                    if ( _menuEntries[ _selectedEntry ].Screen != null ) {
                        ...
                        Framework.AddScreen( new DescriptionBoxScreen( ( _menuEntries[ _selectedEntry ].Screen as LevelBase ).GetDetails() ) );
