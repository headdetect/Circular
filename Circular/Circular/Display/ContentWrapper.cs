...
namespace Circular.Display {
    public class ContentWrapper : GameComponent {
        ...
        private static Dictionary<string, Effect> _effectList = new Dictionary<string, Effect>();
        ...
        private ContentWrapper ( Game game )
            ...
            // Load all graphics
            string[] gfxFolders = { "Images", "Images/Backgrounds/", "Images/Sprites/" };
        ...
        public static Effect GetEffect ( string effectName ) {
            ...
            if ( _contentWrapper != null && _effectList.ContainsKey( effectName ) ) {
