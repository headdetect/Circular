...
namespace Circular.Entity {
    ...
    public abstract class PhysicsSprite : Sprite {
        ...
        protected PhysicsSprite ( CircularGame game, Vector2 size, Vector2 position ) : base( game, size, position ) { }
        ...
        /// <param name="game">The game.</param>
        /// <param name="position">The position.</param>
        protected PhysicsSprite ( CircularGame game, Vector2 position ) : this( game, Vector2.Zero, position ) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicsSprite"/> class.
        /// </summary>
        /// <param name="game">The game.</param>
        protected PhysicsSprite ( CircularGame game ) : this( game, Vector2.Zero, Vector2.Zero ) { }
        ...
        public new bool IsInBounds ( Vector2 point ) {
            ...
            Fixture fix = Game.PhysicsWorld.TestPoint( Game.Camera.ConvertScreenToWorld( point ) );
